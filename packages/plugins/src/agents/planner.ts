...
export const plannerAgent: AgentConfig = {
  description:
    "Creates micro-task plans optimized for parallel execution - one file per task, batched by dependencies",
  mode: "subagent",
  temperature: 0.3,
  prompt: `<environment>
...
Available agents: locator, analyzer, pattern-finder.
</environment>
...
spawn_agent(agent="analyzer", prompt="Read src/hooks/...")  // Just use Read!
spawn_agent(agent="locator", prompt="Find existing files under thoughts/...")  // Just use Glob!
spawn_agent(agent="analyzer", prompt="Read thoughts/shared/designs/...")  // Just use Read!
