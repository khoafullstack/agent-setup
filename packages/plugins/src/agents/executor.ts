...
export const executorAgent: AgentConfig = {
  description:
    "Executes plan with batch-first parallelism - groups independent tasks, spawns all in parallel",
  mode: "subagent",
  temperature: 0.2,
  prompt: `<environment>
...
Available agents: implementer, reviewer, locator, analyzer, pattern-finder.
</environment>
